...
export default function DadosConsumo(props: any){
        ...
        {secaoAtual === 'Produtos/Serviços' &&
            <div className='container-fluid'>
                <form>
                    ...
                    <div>
                        <select className="form-select form-select-lg" aria-label="selecionador de compra" onChange={(e) => setMercadoria(e.target.value)}>
        ...
        {secaoAtual === 'Top 10 clientes' &&
            <div className='container-fluid'>
                <form>
                    ...
                    <div>
                        <select className="form-select form-select-lg" aria-label="selecionador de compra" onChange={(e) => setConsumo(e.target.value)}>
        ...
        {secaoAtual === 'Por tipo de pet' &&
            <div className='container-fluid'>
                <form>
                    <div className='form-label-big'>Mais consumidos</div>
                    <div>
                        <select className="form-select form-select-lg" aria-label="selecionador de compra" disabled>
