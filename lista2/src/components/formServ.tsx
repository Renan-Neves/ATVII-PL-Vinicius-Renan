...
export default class FormServ extends Component<props> {
    ...
    render() {
        ...
        return (
            ...
            <div className='form-label-big' style={{ color: "purple", margin: 10, fontWeight: 'bold' }}>Descrição do Serviço</div>
                <div className="form-floating mb-3" style={{margin: 10}}>
                    ...
                    <label className='form-label-placeholder'>ex: Consulta...</label>
                </div>
